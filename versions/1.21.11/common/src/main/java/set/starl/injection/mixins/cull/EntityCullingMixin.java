...
public abstract class EntityCullingMixin implements EntityCullingAccessor {
	...
	@Unique @Override
	public void lomka$setMotionSampleTick(long tick) { this.lomka$motionSampleTick = tick; }

	@Unique @Override
	public int lomka$getLastRenderTick() { return this.lomka$lastRenderTick; }
	@Unique @Override
	public void lomka$setLastRenderTick(int tick) { this.lomka$lastRenderTick = tick; }

	@Unique @Override
	public int lomka$getLastRenderCamHash() { return this.lomka$lastRenderCamHash; }
	@Unique @Override
	public void lomka$setLastRenderCamHash(int hash) { this.lomka$lastRenderCamHash = hash; }

	@Unique @Override
	public int lomka$getLastRenderPosHash() { return this.lomka$lastRenderPosHash; }
	@Unique @Override
	public void lomka$setLastRenderPosHash(int hash) { this.lomka$lastRenderPosHash = hash; }

	@Unique @Override
	public int lomka$getLastRenderMotionHash() { return this.lomka$lastRenderMotionHash; }
	@Unique @Override
	public void lomka$setLastRenderMotionHash(int hash) { this.lomka$lastRenderMotionHash = hash; }

	@Unique @Override
	public boolean lomka$isRenderVisible() { return this.lomka$renderVisible; }
	@Unique @Override
	public void lomka$setRenderVisible(boolean visible) { this.lomka$renderVisible = visible; }

	@Unique @Override
	public long lomka$getOcclusionState() { return this.lomka$occlusionState; }
	@Unique @Override
	public void lomka$setOcclusionState(long state) { this.lomka$occlusionState = state; }
}