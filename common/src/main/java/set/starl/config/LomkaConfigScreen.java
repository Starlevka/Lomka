...
public final class LomkaConfigScreen extends Screen {
	...
	private void buildConfigEntries() {
        ...
        this.list.addBooleanOption(
            Component.translatable("lomka.config.entities.client_tick_cull"),
            config.entities.clientTickCull, 
            val -> config.entities.clientTickCull = val,
            Component.translatable("lomka.config.entities.client_tick_cull.tooltip")
        );
        this.list.addBooleanOption(
            Component.translatable("lomka.config.entities.client_tick_cull_include_display"),
            config.entities.clientTickCullIncludeDisplay, 
            val -> config.entities.clientTickCullIncludeDisplay = val,
            Component.translatable("lomka.config.entities.client_tick_cull_include_display.tooltip")
        );
		// NBT section
